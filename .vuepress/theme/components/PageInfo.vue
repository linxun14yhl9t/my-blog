<template>
  <div>
    ...
    <reco-icon v-if="pageInfo.frontmatter.tags" icon="reco-tag" class="tags">
      <span v-for="(subItem, subIndex) in pageInfo.frontmatter.tags" :key="subIndex" class="tag-item" :class="{ 'active': currentTag == subItem }"
  ...
  export default defineComponent({
    ...
    setup(props, ctx) {
      ...
      const formatDateValue = (value) => {
        return new Intl.DateTimeFormat('zh-CN', { dateStyle: 'full' }).format(new Date(value))
      }
